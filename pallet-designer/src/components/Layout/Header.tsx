    ...
    <header className="h-14 border-b border-[var(--color-border)] bg-[var(--color-surface)] flex items-center justify-between px-4 shrink-0">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="hidden sm:flex w-9 h-9 rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] items-center justify-center hover:bg-[var(--color-surface-hover)] transition-colors"
          title="Reset Canvas"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
